"""One-step ActorCritic For Continuing tasks.
    ...
    * Continuing tasks
    * V function approximation for critic.
...
class ActorCriticDistributedV(AgentInterface, ActorCriticInterface):
    ...
    def update(
        ...
        delta = np.mean(next_rewards) - self.mu + (_s1 - _s0) @ self.omega
...
if __name__ == "__main__":
    ...
    print("Fully observable: {0}".format(ActorCriticDistributedV.fully_observable))
    print(agent.label)
